export default function Home({ info }) {
  ...
  return (
    <>
      {info ? (
        <div className="w-[350px] mb-10 h-full md:w-[700px] lg:w-[800px] md:mx-20  relative  md:absolute md:top-1/3 text-black p-5 ">
          <h1 className="flex gap-2 my-2 text-lg mx-12 md:text-xl lg:text-3xl md:mx-16 lg:mx-20">
            Result: <p className="font-bold">{msg}, {info.city}</p>
          </h1>
